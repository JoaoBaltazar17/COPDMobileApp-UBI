...
public class FellingUnwellPageQ3 extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            share.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    redirectActivity( FellingUnwellPageQ3.this, SharePage.class);
                }
            });
            ...
            logout.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText( FellingUnwellPageQ3.this, "LogOut", Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public void onBackPageClick(View view) {
            redirectActivity(FellingUnwellPageQ3.this, FellingUnwellPageQ2.class);
    }

    public void onConfirmPag3ButtonClick(View view) {
        redirectActivity(FellingUnwellPageQ3.this, FellingUnwellPageQ4.class);
    }
}